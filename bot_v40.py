...
# === GABAGOOL STRATEGY v40 (SPEED EDITION) ===
# 3x FASTER than v39! Check every 3 ticks instead of 10
...
WINNER_BUY = 3                # Buy winner at 70c+
...
async def main():
    ...
    print("=" * 60)
    print("  BOT v39 - SMART HYBRID")
    print("  1. Hedge if both sides 40-55c")
    print("  2. Double down when winner ≥70c")
    print("  3. OR buy winner directly if momentum clear!")
    print("=" * 60)
