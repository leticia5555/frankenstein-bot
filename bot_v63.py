...
# ╔══════════════════════════════════════════════════════════════════════════╗
# ║  v63 - FRANKENSTEIN BOT (ORDER BOOK ANALYSIS)                           ║
# ║                                                                          ║
# ║  NEW in v63:                                                             ║
# ║  • Order book imbalance detection (bid/ask pressure)                     ║
# ║  • Spread analysis (tight spread = confident market)                     ║
# ║  • Depth-weighted price signals                                          ║
# ║  • Volume at price analysis                                              ║
# ║  • Smart order routing based on book state                               ║
# ║                                                                          ║
# ║  The insight from Polymarket's CLOB:                                     ║
# ║  - Prices are set by ORDER FLOW, not algorithms                          ║
# ║  - Book imbalance predicts short-term price movement                     ║
# ║  - Spread width indicates market confidence                              ║
# ╚══════════════════════════════════════════════════════════════════════════╝
...
class MLModel:
    ...
    def load_and_train(self):
        try:
            ...
            for data_file in [DATA_FILE, "btc_15m_data_v62.csv", "btc_15m_data_v61.csv"]:
                try:
...
class TradeTracker:
    def __init__(self, filename="trades_v63.csv"):
...
async def run_trade_mode():
    ...
    book_analyzer = OrderBookAnalyzer()  # NEW

    print("=" * 65)
    print("  v63 FRANKENSTEIN - TRADING MODE (ORDER BOOK + ML + EV)")
...
async def run_book_mode():
    ...
    print("=" * 65)
    print("  v63 FRANKENSTEIN - ORDER BOOK VIEWER")
...
def main():
    print()
    print("╔══════════════════════════════════════════════════════════════════╗")
    print("║            v63 - FRANKENSTEIN (ORDER BOOK EDITION)              ║")
    print("╠══════════════════════════════════════════════════════════════════╣")
    print("║  NEW: Order book imbalance analysis                              ║")
    print("║  • Detects bid/ask pressure before price moves                   ║")
    print("║  • Uses spread width as confidence signal                        ║")
    print("║  • Combines ML + Book signals for better entries                 ║")
    print("╠══════════════════════════════════════════════════════════════════╣")
    print("║  MODES:                                                          ║")
    print("║  python3 bot_v63.py --trade    # Trade with ML + Book signals   ║")
    print("║  python3 bot_v63.py --book     # Watch order book in real-time  ║")
    print("║  python3 bot_v63.py --analyze  # Analyze trade history          ║")
    print("╚══════════════════════════════════════════════════════════════════╝")
    print()

    if len(sys.argv) < 2:
        print("Usage:")
        print("  python3 bot_v63.py --trade    # Trade with order book analysis")
        print("  python3 bot_v63.py --book     # Watch order book live")
        print("  python3 bot_v63.py --analyze  # Analyze past trades")
        return
