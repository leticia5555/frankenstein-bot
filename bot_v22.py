...
def check_for_new_market():
    global position, recent_prices, position_is_sure_thing, position_is_lag_trade, has_traded_this_candle, edge_trades_up, edge_trades_dn, session_pnl, trade_count
...
async def main():
    ...
    print("=" * 60)
    print("  BOT v22 - FIXES EXPIRED MARKET HANDLING")
    print("=" * 60)
