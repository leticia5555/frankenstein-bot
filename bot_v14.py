...
async def main():
    ...
    print("=" * 60)
    print("  BOT v14 - SURE THING REQUIRES BTC CONFIRMATION")
    print("=" * 60)
            ...
            async with websockets.connect(
                ...
                async for msg in ws:
                    ...
                    # LOOKING FOR ENTRY
                        ...
                        # This prevents buying DN at 80c when BTC is only -0.02%
                        elif m["up"] >= SURE_THING_PRICE_TRIGGER and m["up"] <= SURE_THING_MAX_PRICE:
                            if btc_change >= SURE_THING_PRICE_MIN_BTC:  # BTC must be UP at least 0.03%
                                sure_thing = True
                                sure_side = "UP"
                                sure_token = m["up_t"]
                                sure_price = m["up"]
                            ...
                            if btc_change <= -SURE_THING_PRICE_MIN_BTC:  # BTC must be DOWN at least 0.03%
                                sure_thing = True
                                sure_side = "DN"
                                sure_token = m["dn_t"]
                                sure_price = m["dn"]
