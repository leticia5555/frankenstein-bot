...
# ╔══════════════════════════════════════════════════════════════════════════╗
# ║  v66 - FRANKENSTEIN (PHYSICS ENGINE)                                    ║
# ║                                                                          ║
# ║  NEW in v66: Pure physics-based trading                                  ║
...
# === PARAMETERS ===
DATA_FILE = "btc_15m_data_v66.csv"
MIN_CANDLES_TO_TRAIN = 96
BET_AMOUNT = 5.0
MIN_TIME_LEFT = 5.0  # v66: need 5 min left minimum

# === v66 PHYSICS PARAMETERS ===
...
class PhysicsEngine:
    """
    v66: Pure physics-based signal detection.
    ...
    def get_signal(self, minutes_elapsed):
        """
        The v66 physics decision engine.
        ...
        if reversing:
            return False, None, 0, "reversing (44% — skip)"
...
class TradeTracker:
    def __init__(self, filename="trades_v66.csv"):
...
async def run_trade_mode():
    ...
    # v66: No ML model needed — physics only
    ...
    print("=" * 65)
    print("  v66 FRANKENSTEIN - PHYSICS ENGINE")
...
def main():
    ...
    print("╠══════════════════════════════════════════════════════════════════╣")
    print("║  MODES:                                                          ║")
    print("║  python3 bot_v66.py --trade    # Physics-based trading          ║")
    print("║  python3 bot_v66.py --analyze  # Analyze trade history          ║")
    print("╚══════════════════════════════════════════════════════════════════╝")
    print()
    ...
    if len(sys.argv) < 2:
        print("Usage:")
        print("  python3 bot_v66.py --trade    # Physics-based trading")
        print("  python3 bot_v66.py --analyze  # Analyze past trades")
        return
